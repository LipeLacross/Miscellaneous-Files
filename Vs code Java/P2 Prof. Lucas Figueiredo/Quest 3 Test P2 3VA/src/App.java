...
public class App {
    public static void main(String[] args) throws Exception {
        System.out.println("=====Perfis do instagram=====");
        Perfil felipeMoreira = new Perfil("Felipe Moreira Rios", "@lipe_lacross");
        Perfil lucasFigueiredo = new Perfil("Lucas Figuereido de Oliveira", "@figoredo");
        
        Profile lucasMoreira = new Profile();
        Profile mateusMoreira = new Profile();
    }
}
